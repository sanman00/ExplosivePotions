...
public class ItemThrowableExplosivePotion extends Item {
    public ItemThrowableExplosivePotion() {
       ...
       this.setRegistryName(Main.MOD_ID, ModUtil.THROWABLE_EXPLOSIVE_POTION_NAME);
    }

    @Override
    public void fillItemGroup(ItemGroup tab, NonNullList<ItemStack> subItems) {
        ItemUtil.addItemVariants(ModItems.THROWABLE_EXPLOSIVE_POTION, tab, ExplosivePotionsCreativeTab.INSTANCE, subItems);
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand) {
        return ItemUtil.throwPotion(this, random, world, player, hand, false);
    }
