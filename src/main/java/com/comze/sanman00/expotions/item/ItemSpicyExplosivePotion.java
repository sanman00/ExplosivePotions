...
public class ItemSpicyExplosivePotion extends Item {
    public ItemSpicyExplosivePotion() {
       ...
       this.setRegistryName(Main.MOD_ID, ModUtil.SPICY_EXPLOSIVE_POTION_NAME);
    }

    @Override
    public void fillItemGroup(ItemGroup tab, NonNullList<ItemStack> subItems) {
        ItemUtil.addItemVariants(ModItems.SPICY_EXPLOSIVE_POTION, tab, ExplosivePotionsCreativeTab.INSTANCE, subItems);
    }
